...
func TestRPC_Hvm(t *testing.T) {
	//t.Skip()
	deployJar, err := ioutil.ReadFile("../hvmtestfile/fibonacci/fibonacci-1.0-fibonacci.jar")
	if err != nil {
		t.Error(err)
	}
...
func TestRPC_DirectInvoke(t *testing.T) {
	...
	deployJar, err := ioutil.ReadFile("../hvmtestfile/directInvoke/directInvokeTest-1.0.jar")
	if err != nil {
		t.Error(err)
	}
