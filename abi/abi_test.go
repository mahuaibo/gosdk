...
const jsondata3 = `
[	
	{ "type" : "constructor", "inputs" : [ { "name" : "amount", "type" : "uint32" } ] },
	{ "type" : "function", "name" : "balance", "constant" : true },
	{ "type" : "function", "name" : "send", "constant" : false, "inputs" : [ { "name" : "amount", "type" : "uint256" } ] },
	{ "type" : "function", "name" : "test", "constant" : false, "inputs" : [ { "name" : "number", "type" : "uint32" } ] },
	{ "type" : "function", "name" : "string", "constant" : false, "inputs" : [ { "name" : "inputs", "type" : "string" } ] },
...
const jsondata4 = `
[
	{"constant":false,"inputs":[{"name":"a1","type":"int24"}],"name":"overloadTest","outputs":[{"name":"","type":"int24"}],"payable":false,"stateMutability":"nonpayable","type":"function"},
	{"constant":false,"inputs":[{"name":"a1","type":"bool[]"}],"name":"overloadTest","outputs":[{"name":"","type":"bool[]"}],"payable":false,"stateMutability":"nonpayable","type":"function"},
	{"constant":false,"inputs":[{"name":"a1","type":"bool"}],"name":"overloadTest","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},
	{"anonymous": false,"inputs": [{"indexed": false, "name": "a1", "type": "uint128"}],"name": "overloadEventTest","type": "event"},
	{"anonymous": false,"inputs": [],"name": "overloadEventTest","type": "event"}
]`
...
func TestReader(t *testing.T) {
	...
	for name, expM := range exp.Methods {
		gotMPtr, err := abi.GetMethod(name)
		gotM := *gotMPtr
		if err != nil {
...
func TestConstructor(t *testing.T) {
	abi, err := JSON(strings.NewReader(jsondata3))
	fmt.Println(abi)
	if err != nil {
		t.Error(err)
		t.FailNow()
	...
	if _, err := abi.Pack("", uint32(32)); err != nil {
		t.Error(err)
	}
	if _, err := abi.Pack("", "a"); err == nil {
		t.Error(err)
	}
	if _, err := abi.Pack("123"); err == nil {
		t.Error(err)
	}
	abi.GetPayload("send", "1")
}
func TestOverload(t *testing.T) {
	abi, err := JSON(strings.NewReader(jsondata4))
	if err != nil {
		t.Error(err)
		t.FailNow()
	}
	if _, err := abi.GetMethod("overloadTest"); err != nil {
		t.Error(err)
	}
	if _, err := abi.GetMethod("overloadTest(int24)"); err != nil {
		t.Error(err)
	}
	if _, err := abi.GetMethod("overloadTest(bool[])"); err != nil {
		t.Error(err)
	}
	if _, err := abi.GetMethod("overloadTest(bool)"); err != nil {
		t.Error(err)
	...
	if _, err := abi.GetEvent("overloadEventTest"); err != nil {
		t.Error(err)
	}
	if _, err := abi.GetEvent("overloadEventTest(uint128)"); err != nil {
		t.Error(err)
	}
	if _, err := abi.GetEvent("overloadEventTest()"); err != nil {
		t.Error(err)
...
func TestMethodSignature(t *testing.T) {
	...
	idexp, _ := hash.NewHasher(hash.KECCAK_256).Hash([]byte(exp))
	idexp = idexp[:4]
...
func TestMultiPack(t *testing.T) {
	...
	sig, _ := hash.NewHasher(hash.KECCAK_256).Hash([]byte("bar(uint32,uint16)"))
	sig = sig[:4]
...
func TestDefaultFunctionParsing(t *testing.T) {
	...
	if _, err := abi.GetMethod("balance"); err != nil {
