...
func TestParseContractData(t *testing.T) {
	...
	InitContract(bytes)
	ParseContractData(Contract, ClassMap[MainClass], "eef907d9b8a4a61f353d6759055f47ec7e09ee61", true, "/Users/dong/go/src/github.com/ultramesh/hvmd/storage/runtime/data", nil)
}

func TestParseContractData2(t *testing.T) {
	t.Skip("no hvmd")
	addr := "1f69751671f4aa9c3753959be9d79ce546989bea"
	path := "/Users/dong/go/src/github.com/ultramesh/hvmd/storage/runtime/data"
	bytes, err := DecompressJar("test-jar/hvm-bench-test-2.0-SNAPSHOT-student.jar")
	if err != nil {
		fmt.Println(err)
		return
...
func TestHyperList(t *testing.T) {
	...
	//fmt.Println("****")
	ParseContractData(Contract, ClassMap[MainClass], "96a7f4f37b1d349b534891ac8734211a88ee2998", true, "/Users/dong/go/src/github.com/hyperchain/hyperchain/build/node1/namespaces/global/data/leveldb/blockchain", nil)
	InitContract(decompressJar)
	ParseContractData(Contract, ClassMap[MainClass], "96a7f4f37b1d349b534891ac8734211a88ee2998", true, "/Users/dong/go/src/github.com/hyperchain/hyperchain/build/node1/namespaces/global/data/leveldb/blockchain", nil)
